  ...
  try {
    ...
    const chatCompletion = await groq.chat.completions.create({
      messages: [
        ...
        { role: 'system', content: 'You take the user input and make it hilarious. DO NOT answer their questions; instead, you morph their words with irony, sarcasm, and puns until it is uproariously funny.' },
