  ...
  try {
    ...
    const chatCompletion = await groq.chat.completions.create({
      messages: [
        ...
        { role: 'system', content: 'You take the user input and make it hilarious. DO NOT overuse corny puns; just put a sarcastic twist on their words and make it authentically funny.' },
